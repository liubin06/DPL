...
def parse_args():
    ...
    # Training Args
    # Dataset
    parser.add_argument('--dataset', default='100k', help='dataset')  # 100k yahoo 1M gowalla yelp2018
    ...
    parser.add_argument('--LOSS', default='DPL', help='choose loss function')
    ...
    parser.add_argument('--tau_plus', type=float, default=0.06, help='tau_plus')
